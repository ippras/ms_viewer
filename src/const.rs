...
pub(crate) const NORMALIZED: &str = "Normalized";
...
pub(crate) const COVARIANCE: &str = "Covariance";
pub(crate) const CORRELATION: &str = "Correlation";
pub(crate) const SLOPE: &str = "Slope";
pub(crate) const INTERCEPT: &str = "Intercept";

pub(crate) const EIC: &str = "ExtractedIonChromatogram";
pub(crate) const TIC: &str = "TotalIonChromatogram";
